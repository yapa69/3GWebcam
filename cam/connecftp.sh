...
if [[ $1 = "fulltemp" ]]
then
scp -i /home/pi/.ssh/id_rsa -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null /home/pi/cam/img/lastvideo.mp4 tbirckel@kim.terrier.im:echartet$fichiermp4
